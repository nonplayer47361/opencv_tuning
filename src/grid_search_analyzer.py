...
EXPERIMENTAL_PLAN = [
    {
        'experiment_name': 'Baseline_Tophat',
        'use_msrcr': False,
        'enhancement_filter': 'tophat',
        'base_pipeline': ['clahe', 'blur', 'ENHANCER_SLOT', 'threshold']
    },
    {
        'experiment_name': 'Replace_with_DoG',
        'use_msrcr': False,
        'enhancement_filter': 'dog',
        'base_pipeline': ['clahe', 'blur', 'ENHANCER_SLOT', 'threshold']
    },
    {
        'experiment_name': 'Replace_with_Hessian',
        'use_msrcr': False,
        'enhancement_filter': 'hessian',
        'base_pipeline': ['clahe', 'blur', 'ENHANCER_SLOT', 'threshold']
    },
    {
        'experiment_name': 'Add_MSRCR_with_Tophat_NoCLAHE',
        'use_msrcr': True,
        'enhancement_filter': 'tophat',
        'base_pipeline': ['blur', 'ENHANCER_SLOT', 'threshold']
    },
]
